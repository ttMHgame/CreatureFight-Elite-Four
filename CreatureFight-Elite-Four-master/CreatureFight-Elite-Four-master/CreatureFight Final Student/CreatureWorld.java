...
public class CreatureWorld extends World
{
    ...
    Creature[] playerOneCreatures;
    Creature[] playerTwoCreatures;
    ...
    private void prepareCreatures()
    {
        ...
        for(int i = 0;i< playerTwoCreatures.length;i++){
            ...
            if(i == 0){
                 ...
                 *          a y location of getHeight() - playerOneCreatures[i].getImage().getHeight()/2
                 */
                addObject(playerTwoCreatures[i], playerTwoCreatures[i].getImage().getWidth()/2,getHeight() - playerTwoCreatures[i].getImage().getHeight()/2);
            ...
            //TODO (85): Otherwise...
               ...
               playerTwoCreatures[i].getImage().setTransparency(0);
                 ...
                 *          getHeight() - playerOneCreatures[i].getImage().getHeight()/2
                 */
                addObject(playerTwoCreatures[i], 0, getHeight() - playerTwoCreatures[i].getImage().getHeight()/2);
